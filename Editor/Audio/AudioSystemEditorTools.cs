...
namespace CFramework.Editor.AudioSystem
{
    ...
    public static class AudioSystemEditorTools
    {
        ...
        public static void CreateAudioConfig()
        {
            ...
            string configPath = CFDirectoryKey.FrameworkConfig + "/AudioConfig.asset";
        ...
        {
            AudioConfig config = AudioSystemEditorModule.GetAudioConfig();
            if(config == null)
            {
        ...
        public static void CheckConfigStatus()
        {
            ...
            string message = "AudioConfig 配置状态：\n\n" +
