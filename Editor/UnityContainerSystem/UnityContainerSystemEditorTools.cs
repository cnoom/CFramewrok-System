...
namespace CFramework.Editor.UnityContainerSystem
{
    ...
    public static class UnityContainerSystemEditorTools
    {
        ...
        public static void CreateUnityContainerConfig()
        {
            ...
            string configPath = CFDirectoryKey.FrameworkConfig + "/UnityContainerConfig.asset";
        ...
        {
            UnityContainerConfig config = UnityContainerSystemEditorModule.GetUnityContainerConfig();
            if(config == null)
            {
        ...
        public static void CheckConfigStatus()
        {
            ...
            string message = "UnityContainerConfig 配置状态：\n\n" +
        ...
        public static void SyncToAddressables()
        {
            ...
            Type processorType = Type.GetType("CFramework.Editor.AddressablesTools.SingleAddressAssetProcessor, CFramework.Attachment.Editor");
            if(processorType != null)
            {
                MethodInfo processAllMethod = processorType.GetMethod("ProcessAll", BindingFlags.Public | BindingFlags.Static);
